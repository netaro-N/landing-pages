$(function(){
  ...
  $("#resetBtn").click(function(){
    if(window.confirm('ツイートをすべて削除してもよしいですか？')){
  ...
  function tweetDraw(){
    ...
    if(tweetArray.length > 0){
      ...
      tweetArray.forEach(function(){
        ...
        tweetHtml += '<div class="stream-item"><div class="stream-item-header"><img src="assets/img/profile.jpeg" width="48" height="48"><span class="full-name">Netaro</span><span class="user-name">@netaro</span></div><div class="tweet-text">' +  tweetArray[i] + '</div></div>';
        i--;
      });
