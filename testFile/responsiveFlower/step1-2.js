...
var conw = container.clientWidth;   // 【可変】親要素の幅
var conh = container.clientHeight;   // 【準固定】親要素の高さ(ここもビューポートによってレスポンシブなのでリサイズ時に常に取得)
...
var imgBaseSizeW = 15/1000*conw;    // 画像の基本サイズ横幅(1000のとき15)
